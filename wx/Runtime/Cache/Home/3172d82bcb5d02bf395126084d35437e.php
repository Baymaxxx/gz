...
<link href="/lnweb/gz/wx/Public/static/font-awesome/css/font-awesome.min.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/lnweb/gz/wx/Public/Home/css/base.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/lnweb/gz/wx/Public/Home/css/module.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/lnweb/gz/wx/Public/Home/css/weiphp.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/lnweb/gz/wx/Public/static/emoji.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>
<script src="/lnweb/gz/wx/Public/static/bootstrap/js/html5shiv.js?v=<?php echo SITE_VERSION;?>"></script>
<![endif]-->

<!--[if lt IE 9]>
<script type="text/javascript" src="/lnweb/gz/wx/Public/static/jquery-1.10.2.min.js"></script>
<![endif]-->
<!--[if gte IE 9]><!-->
<script type="text/javascript" src="/lnweb/gz/wx/Public/static/jquery-2.0.3.min.js"></script>
<!--<![endif]-->
<script type="text/javascript" src="/lnweb/gz/wx/Public/static/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/lnweb/gz/wx/Public/static/uploadify/jquery.uploadify.min.js"></script>
<script type="text/javascript" src="/lnweb/gz/wx/Public/static/zclip/ZeroClipboard.min.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/lnweb/gz/wx/Public/Home/js/dialog.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/lnweb/gz/wx/Public/Home/js/admin_common.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/lnweb/gz/wx/Public/Home/js/admin_image.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/lnweb/gz/wx/Public/static/masonry/masonry.pkgd.min.js"></script>
<script type="text/javascript" src="/lnweb/gz/wx/Public/static/jquery.dragsort-0.5.2.min.js"></script> 
<script type="text/javascript">
var  IMG_PATH = "/lnweb/gz/wx/Public/Home/images";
var  STATIC = "/lnweb/gz/wx/Public/static";
var  ROOT = "/lnweb/gz/wx";
...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="wrap">
       ...
       <?php if(!empty($userInfo[website_logo])): ?><img height="52" src="<?php echo (get_cover_url($userInfo["website_logo"])); ?>"/>
       	<?php else: ?>
       		<img height="52" src="/lnweb/gz/wx/Public/Home/images/logo.png"/><?php endif; ?>
       </a>
                ...
                <?php if(is_login()): ?><ul class="nav" style="margin-right:0">
                        ...
                        <li class="dropdown admin_nav">
                            <a href="#" class="dropdown-toggle login-nav" data-toggle="dropdown" style="">
                                ...
                                <?php else: ?>
                                    <img class="admin_head default" src="/lnweb/gz/wx/Public/Home/images/default.png"/><?php endif; ?>
...
(function(){
	var ThinkPHP = window.Think = {
		"ROOT"   : "/lnweb/gz/wx", //当前网站地址
		"APP"    : "/lnweb/gz/wx/index.php?s=", //当前项目地址
		"PUBLIC" : "/lnweb/gz/wx/Public", //项目公共目录地址
  ...
  <link href="/lnweb/gz/wx/Public/static/datetimepicker/css/datetimepicker.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
  <?php if(C('COLOR_STYLE')=='blue_color') echo '
    <link href="/lnweb/gz/wx/Public/static/datetimepicker/css/datetimepicker_blue.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
    '; ?>
  <link href="/lnweb/gz/wx/Public/static/datetimepicker/css/dropdown.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
  <script type="text/javascript" src="/lnweb/gz/wx/Public/static/datetimepicker/js/bootstrap-datetimepicker.js"></script> 
  <script type="text/javascript" src="/lnweb/gz/wx/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=<?php echo SITE_VERSION;?>" charset="UTF-8"></script> 
  <script type="text/javascript">
